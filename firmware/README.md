...
| [`robot_motor_bts7960/robot_motor_bts7960.ino`](robot_motor_bts7960/robot_motor_bts7960.ino) | Llama Motor Board | Ramps toward the commanded left/right PWM on four BTS7960 channels, with a 300 ms fail-safe stop |
...
| [`robot_encoders_as5600/robot_encoders_as5600.ino`](robot_encoders_as5600/robot_encoders_as5600.ino) | Llama Encoder Board (prototype on a breadboard) | Reads two AS5600 wheel encoders (one per I2C bus), broadcasts `EncoderPacket{left, right, ms}` (12 bytes) over ESP-NOW ~50x/sec |
